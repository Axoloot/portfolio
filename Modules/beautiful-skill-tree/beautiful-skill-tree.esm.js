...
import { v4 } from 'uuid';
import styled, { ThemeProvider, ThemeContext, css as css$7 } from 'styled-components';
...
_templateObject$b(), function (_ref) {
  ...
  return !isVisible && css$7(["transition:transform 0.15s ease-out,opacity 0.15s ease-out,max-height 0.15s ease-out,visibility 0.15s 0.15s ease-out;transform:scaleY(0);visibility:hidden;max-height:0;width:304px;opacity:0;"]);
});
