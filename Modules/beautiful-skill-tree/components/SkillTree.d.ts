...
declare function SkillTree({ data, title, description, closedByDefault, treeId, savedData, handleSave, handleNodeSelect, disableHeader, collapsible, disabled, }: Props): JSX.Element;
